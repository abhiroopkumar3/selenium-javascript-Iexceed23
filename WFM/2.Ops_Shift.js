...
describe("OPS Shift Screen : ", function () {
    ...
    it("2. Open OPS Shift Screen", async function () {
        ...
        await driver.findElement(By.xpath("//span[text()='Ops Shifts']")).click();
        await driver.sleep(6000);
        ...
        fs.writeFileSync('./Screenshots/Ops_Shift.png', encodedString, 'base64');
    ...
    it("6. Modify a Shift", async function(){
        ...
        await driver.findElement(By.id("bshift__NewShift__el_cbx_3_1_lbl")).click();
        await driver.findElement(By.id("bshift__NewShift__el_btn_3")).click();
